...
mpHands.HAND_CONNECTIONS,
 mpDraw.DrawingSpec(color=(125, 0,
125), thickness=2, circle_radius=4),
 mpDraw.DrawingSpec(color=(255, 0,
255), thickness=2, circle_radius=2)
 )
 # Get landmarks for thumb and index finger
 thumb = (handLandmarks.landmark[4].x,
handLandmarks.landmark[4].y)
 index_finger = (handLandmarks.landmark[8].x,
handLandmarks.landmark[8].y)
 ...
 hand_open = False
 # Render counter
 cv2.putText(img, f"Count: {counter}", (50, 50),
